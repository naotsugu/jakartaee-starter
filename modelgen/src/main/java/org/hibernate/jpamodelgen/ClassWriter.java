...
import com.mammb.jakartaee.starter.lib.modelgen.ClassWriteEnhancer;
...
public class ClassWriter {
    ...
    public static void writeFile(MetaEntity entity, Context context) {
        try {
            ...
            pw.println(ClassWriteEnhancer.generateEnhanceImports());
            pw.println(body);
    ...
    private static StringBuffer generateBody(MetaEntity entity, Context context) {
        ...
        try {
            ...
            pw.println("    // -- Enhance -------------------------------------------------------------");
            pw.println();
            pw.println(ClassWriteEnhancer.generateEnhanceRootClass(entity, context));
            pw.println(ClassWriteEnhancer.generateEnhanceJoinClass(entity, context));
            pw.println(ClassWriteEnhancer.generateEnhancePathClass(entity, context));
